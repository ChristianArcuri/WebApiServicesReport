...
{
    public partial class RegulatoryComplianceCompanyReportExcel : DevExpress.XtraReports.UI.XtraReport
    {
        public RegulatoryComplianceCompanyReportExcel()
        {
            InitializeComponent();
        }
        ...
        private void RegulatoryComplianceReportExcel_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as RegulatoryComplianceCompanyReportExcel).sqlDataSource2.ConnectionParameters = dataConnectionParametersBase;
