...
{
    public partial class EndOfDayCompanyReportSummaryCancelWires : DevExpress.XtraReports.UI.XtraReport
    {
        public EndOfDayCompanyReportSummaryCancelWires()
        {
            InitializeComponent();
        }      
        ...
        private void EndOfDayReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as EndOfDayCompanyReportSummaryCancelWires).sqlDataSource1.ConnectionParameters = dataConnectionParametersBase; 
