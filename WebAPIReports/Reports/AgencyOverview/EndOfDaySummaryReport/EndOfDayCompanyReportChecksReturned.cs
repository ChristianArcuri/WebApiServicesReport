...
{
    public partial class EndOfDayCompanyReportChecksReturned : DevExpress.XtraReports.UI.XtraReport
    {
        public EndOfDayCompanyReportChecksReturned()
        {
            InitializeComponent();
        ...
        private void CombinedReportChecks_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
                ...
                (sender as EndOfDayCompanyReportChecksReturned).sqlDataSource1.ConnectionParameters = dataConnectionParametersBase;
            }
            catch
            {
