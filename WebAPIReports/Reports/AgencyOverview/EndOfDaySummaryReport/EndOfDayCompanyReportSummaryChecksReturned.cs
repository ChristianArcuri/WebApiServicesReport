...
{
    public partial class EndOfDayCompanyReportSummaryChecksReturned : DevExpress.XtraReports.UI.XtraReport
    {
        public EndOfDayCompanyReportSummaryChecksReturned()
        {
            InitializeComponent();
        ...
        private void CombinedReportChecks_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
                ...
                (sender as EndOfDayCompanyReportSummaryChecksReturned).DataSourceChecks.ConnectionParameters = dataConnectionParametersBase;
            }
            catch
            {
