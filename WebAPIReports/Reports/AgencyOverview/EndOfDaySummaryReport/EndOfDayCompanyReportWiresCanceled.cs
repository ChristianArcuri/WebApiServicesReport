...
{
    public partial class EndOfDayCompanyReportWiresCanceled : DevExpress.XtraReports.UI.XtraReport
    {
        public EndOfDayCompanyReportWiresCanceled()
        {
            InitializeComponent();
        }      
        ...
        private void EndOfDayReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as EndOfDayCompanyReportWiresCanceled).sqlDataSource1.ConnectionParameters = dataConnectionParametersBase; 
