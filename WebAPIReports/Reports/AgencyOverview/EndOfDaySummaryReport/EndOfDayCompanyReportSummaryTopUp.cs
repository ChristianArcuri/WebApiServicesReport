...
{
    public partial class EndOfDayCompanyReportSummaryTopUp : DevExpress.XtraReports.UI.XtraReport
    {
        
        public EndOfDayCompanyReportSummaryTopUp()
        {
            InitializeComponent();
        }      
        ...
        private void EndOfDayReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as EndOfDayCompanyReportSummaryTopUp).sqlDataSource1.ConnectionParameters = dataConnectionParametersBase; 
