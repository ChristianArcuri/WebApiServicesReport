...
{
    public partial class EndOfDayCompanyReportBillPayment : DevExpress.XtraReports.UI.XtraReport
    {
        public EndOfDayCompanyReportBillPayment()
        {
            InitializeComponent();
        }      
        ...
        private void EndOfDayReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as EndOfDayCompanyReportBillPayment).sqlDataSource1.ConnectionParameters = dataConnectionParametersBase; 
