...
{
    public partial class EndOfDayCompanyReportSummaryCashBack : DevExpress.XtraReports.UI.XtraReport
    {
        public EndOfDayCompanyReportSummaryCashBack()
        {
            InitializeComponent();
        }      
        ...
        private void EndOfDayReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as EndOfDayCompanyReportSummaryCashBack).sqlDataSource1.ConnectionParameters = dataConnectionParametersBase; 
