...
{
    public partial class RegulatoryComplianceReport : DevExpress.XtraReports.UI.XtraReport
    {
        public RegulatoryComplianceReport()
        {
            InitializeComponent();
        }
        ...
        private void RegulatoryComplianceReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as RegulatoryComplianceReport).sqlDataSource2.ConnectionParameters = dataConnectionParametersBase;
