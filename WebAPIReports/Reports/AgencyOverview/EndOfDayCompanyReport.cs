...
{
    public partial class EndOfDayCompanyReport : DevExpress.XtraReports.UI.XtraReport
    {
        public EndOfDayCompanyReport()
        {
            InitializeComponent();
        }
        ...
        private void EndOfDayReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as EndOfDayCompanyReport).sqlDataSource1.ConnectionParameters = dataConnectionParametersBase;
