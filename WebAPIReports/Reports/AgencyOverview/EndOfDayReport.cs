...
{
    public partial class EndOfDayReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void EndOfDayReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as EndOfDayReport).sqlDataSource1.ConnectionParameters = dataConnectionParametersBase;
