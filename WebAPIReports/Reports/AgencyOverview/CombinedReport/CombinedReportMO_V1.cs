...
{
    public partial class CombinedReportMO_V1 : DevExpress.XtraReports.UI.XtraReport
    {
        public CombinedReportMO_V1()
        {
            InitializeComponent();
        }
        ...
        private void CombinedReportMO_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
                ...
                (sender as CombinedReportMO_V1).DataSourceMO.ConnectionParameters = dataConnectionParametersBase;
            }
            catch
            {
        ...
        private void DataSourceMO_ConfigureDataConnection(object sender, DevExpress.DataAccess.Sql.ConfigureDataConnectionEventArgs e)
        {
            ...
            if (e.ConnectionName == "MoneyOrderConnectionString")
