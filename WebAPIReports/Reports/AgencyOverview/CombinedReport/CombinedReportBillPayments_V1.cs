...
{
    public partial class CombinedReportBillPayments_V1 : DevExpress.XtraReports.UI.XtraReport
    {
        public CombinedReportBillPayments_V1()
        {
            InitializeComponent();
        }
        ...
        private void CombinedReportBillPayments_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as CombinedReportBillPayments_V1).DataSourceBillPayment.ConnectionParameters = dataConnectionParametersBase;
        }
