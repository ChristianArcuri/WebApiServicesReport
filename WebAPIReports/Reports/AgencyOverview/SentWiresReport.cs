...
{
    public partial class SentWiresReport : DevExpress.XtraReports.UI.XtraReport
    {
        public SentWiresReport()
        {
            InitializeComponent();
        }
        ...
        private void SentWiresReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as SentWiresReport).sqlDataSource1.ConnectionParameters = dataConnectionParametersBase;
