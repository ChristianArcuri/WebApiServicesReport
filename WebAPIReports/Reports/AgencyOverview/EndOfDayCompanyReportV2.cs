...
{
    public partial class EndOfDayCompanyReportV2 : DevExpress.XtraReports.UI.XtraReport
    {
        public EndOfDayCompanyReportV2()
        {
            InitializeComponent();
        }      
        ...
        private void EndOfDayReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as EndOfDayCompanyReportV2).sqlDataSource1.ConnectionParameters = dataConnectionParametersBase; 
