...
{
    public partial class CompanyRptInvoiceSm : DevExpress.XtraReports.UI.XtraReport
    {
        #region properties
       ...
       private void xrTSummary_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        ...
        private void RptInvoice_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            (sender as CompanyRptInvoiceSm).WireTransac.ConnectionParameters = dataConnectionParametersBase;
            ...
            (sender as CompanyRptInvoiceSm).WireSecurity.ConnectionParameters = dataConnectionParametersBase;
        }
        ...
        private void xrTDebitCard_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                fp = new CultureInfo(ReportCommon.CultureInfoEnUs);
            }
            else
                fp = new CultureInfo(ReportCommon.CultureInfoEsMX);
        ...
        private void xrTpUpAmount_PrintOnPage(object sender, PrintOnPageEventArgs e)
        {
            (sender as XRLabel).Text = string.Format(Constants.MoneyFormat, amountTopUp);
        }

        private void xrQtyTpUp_PrintOnPage(object sender, PrintOnPageEventArgs e)
        {
            (sender as XRLabel).Text = qtyTopUp.ToString();
        }

        private void xrTableRowTopUp_PrintOnPage(object sender, PrintOnPageEventArgs e)
        {
            e.Cancel = qtyTopUp == 0;
        }
