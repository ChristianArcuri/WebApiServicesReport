...
{
    public partial class CompanyReportHeaderTitle : DevExpress.XtraReports.UI.XtraReport
    {
        #region properties

        #endregion
        public CompanyReportHeaderTitle()
        {
            InitializeComponent();
        }
        ...
        private void CompanyReportHeader_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
                ...
                (sender as CompanyReportHeaderTitle).DataSourceCompanyReportHeader.ConnectionParameters = dataConnectionParametersBase;
            }
            catch (Exception ex)
            {
        ...
        private void CompanyReportHeader_BeforePrint(object sender, PrintEventArgs e)
        {
            ...
            this.Landscape = true;
            this.xrLabel1.SizeF = new System.Drawing.SizeF(1080, 27.95833F);
